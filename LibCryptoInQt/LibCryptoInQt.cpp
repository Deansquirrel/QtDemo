...
QString LibCryptoInQt::CalcDynamicDigestCode4Len5(QDateTime dValidTime, QString sPlaintext) throw(QString)
{
    ...
    long sVerifyNum = 0;
    sVerifyNum = sVerifyNum + (sMd5Code.mid(0,8).toLong(nullptr,16) % 100000000);
    sVerifyNum = sVerifyNum + (sMd5Code.mid(8,8).toLong(nullptr,16) % 100000000);
    sVerifyNum = sVerifyNum + (sMd5Code.mid(16,8).toLong(nullptr,16) % 100000000);
    sVerifyNum = sVerifyNum + (sMd5Code.mid(24,8).toLong(nullptr,16) % 100000000);
